...
// ==========================================
const char* ssid = "WIFI";       // Pon tu red aquí
const char* password = "PASS"; // Pon tu contraseña aquí
const char* mqtt_server = "192.168.1.X";      // Pon la IP de tu Raspberry Pi aquí
